...
plt.savefig("IF_21B_TX_120B.%s" % extension,bbox_inches='tight',dpi=330,transparent=transparent_flag)
plt.close()
...
plt.title("Packet Reception Ratio\nunder 22B ACK interference",fontsize=15,pad=16,fontweight="regular")
plt.gca().yaxis.get_label().set_fontsize(11)
plt.gca().yaxis.get_label().set_weight("regular")
plt.gca().yaxis.labelpad = 10
plt.gca().xaxis.get_label().set_fontsize(11)
...
plt.savefig("IF_22B_TX_120B.%s" % extension,bbox_inches='tight',dpi=330,transparent=transparent_flag)
plt.close()
...
plt.title("Packet Reception Ratio\nunder 23B ACK interference",fontsize=15,pad=16,fontweight="regular")
plt.gca().yaxis.get_label().set_fontsize(11)
plt.gca().yaxis.get_label().set_weight("regular")
plt.gca().yaxis.labelpad = 10
plt.gca().xaxis.get_label().set_fontsize(11)
...
plt.savefig("IF_23B_TX_120B.%s" % extension,bbox_inches='tight',dpi=330,transparent=transparent_flag)
plt.close()
